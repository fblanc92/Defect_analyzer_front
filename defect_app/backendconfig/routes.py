...
from Defect_analyzer_front.defect_app.models import Backend_config
...
from Defect_analyzer_back.resources.config.configs_utils import update_config, get_current_config_json
...
def edit_backend_config():  # no argument config_id argument because the idea is edit the ONLY config
    ...
    form.path_to_current_coil_register_folder.data = current_config_json['config']['path_to_current_coil_register_folder']
